...
const struct bpf_func_proto bpf_esp_map_proto __weak;
const struct bpf_func_proto bpf_esp_unmap_proto __weak;
const struct bpf_func_proto bpf_esp_read_proto __weak;
const struct bpf_func_proto bpf_esp_write_proto __weak;
